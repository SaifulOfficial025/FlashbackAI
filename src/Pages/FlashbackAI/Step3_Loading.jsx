      ...
      <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 mb-16 relative text-left">
        <div className="flex gap-4 items-start">
          ...
          <p className="text-gray-700 leading-relaxed italic font-medium">
            "I animated an old photo of my childhood dog, Max. Seeing him move again —
            that little head tilt, his gentle expression — it brought me to tears.
            It felt like having a moment with him again."
          </p>
        </div>
